...
\tensor*[]{\tilde{\mathbb{T}}}{^{i_1 \dots i_r}_{j_1 \dots j_s}}= T^{i_1}_{k_1} \dots T^{i_r}_{k_r} \ S^{l_1}_{j_1} \dots S^{l_r}_{j_r} \ \tensor*[]{\mathbb{T}}{^{k_1 \dots k_r}_{l_1 \dots l_s}} \\
\tensor*[]{\mathbb{T}}{^{i_1 \dots i_r}_{j_1 \dots j_s}}= S^{i_1}_{k_1} \dots S^{i_r}_{k_r} \ T^{l_1}_{j_1} \dots T^{l_r}_{j_r} \ \tensor*[]{\tilde{\mathbb{T}}}{^{k_1 \dots k_r}_{l_1 \dots l_s}}
